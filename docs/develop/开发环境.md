...
在YiYiYa根目录下找到Sconstruct文件

1、选择你要编译得平台，目前有以下几种，如果是要玩x86，就选 platform='pc'，`#`符号为注释。

```
platform='pc'  #pc v3s raspi2 esp32 stm32f4xx raspi3 rk3128 cubieboard2 dummy
```
...
CC_PREFIX='i686-elf-'
CC_LIB_PATH='D:\\app\\gcc\\lib\\gcc\\i686-elf\\7.1.0\\' #D:\\Program Files\\gcc-arm-none-eabi-9\\lib\\gcc\\arm-none-eabi\\9.2.1\\  /opt/local/lib/gcc/arm-none-eabi/9.2.0/ /lib/gcc/arm-none-eabi/9.2.1/
