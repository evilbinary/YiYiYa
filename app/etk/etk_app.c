...
int etk_app_main( int argc, char* argv[] ){
	...
	desktop=etk_create_window(0,0,1024,768,ETK_WIDGET_DESKTOP|ETK_WIDGET_NO_BITMAP);
	...
	//������ť
	xsize=52;ysize=40;xspan=5;yspan=5;
	startx=10;starty=DISAPLAY_HEIGHT-ysize-yspan*2;
	x=startx;y=starty;
	for(i=0;i<9;i++){
